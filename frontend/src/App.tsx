...
export default function App() {
  ...
  const adapters = () => <><Heading eyebrow="Managed external runtimes" title="Proxy adapters" description="Register local Xray or sing-box binaries, identify exact pinned official releases, and run their native configuration checks before production use." /><AdapterRegistry records={data.adapters} pins={data.adapterPins} reports={adapterReports} nativeMode={backend.isNative()} busy={adapterBusy} error={adapterError} onPick={pickAdapter} onImport={importAdapter} onVerify={verifyAdapter} onValidate={validateAdapter} onDelete={removeAdapter} /></>
